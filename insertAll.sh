...
echo "  Nittedal"
node import/importer.js -m -f results/2022/nittedal/nittedal-2022.csv
...
echo "  Traktorland"
node import/importer.js -m -f results/2023/traktorland/traktorland-2023.csv

echo "  Harstad"
node import/importer.js -f results/2023/harstad/harstad-2023.csv
...
echo "  Lillehammer"
node import/importer.js -a -f results/2023/lillehammer/lillehammer-2023.csv

echo "  Trysil"
node import/importer.js -m -f results/2023/trysil/trysil-2023.csv
...
echo "  Nittedal"
node import/importer.js -m -f results/2024/nittedal/nittedal-2024.csv

echo "  Trysil"
node import/importer.js -m -f results/2024/trysil/trysil-2024.csv
