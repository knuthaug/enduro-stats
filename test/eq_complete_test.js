...
tap.test('parse complete result file', async t => {
  ...
  t.equal(data.race.uid, '0220cbd5bc43a80de8e69070c3f2872c', 'race uid matches')
...
tap.test('Object details for stages, non-accumulative mode', async t => {
  ...
  t.equal(rider.rider_uid, '105fe7e9a0446b152bef347939aeba57', 'uid is correct')
  ...
  t.equal(stage1.results[1].behind_leader_ms, 1000, 'time behind leader in stage is correct')
})
...
tap.test('Object details for stages, accumulative mode', async t => {
  ...
  t.equal(rider.rider_uid, 'e2c668db34a035fcf81263563b8033e3', 'uid is correct')
  ...
  t.equal(stage1.results[1].behind_leader_ms, 156800, 'time behind leader in stage is correct')
})
