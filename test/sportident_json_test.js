...
tap.test('Object details for stages', async t => {
  ...
  t.equal(rider.rider_uid, '5dc52ab98e430fb12db8d7a6682ebf79', 'uid is correct')
  ...
  t.equal(stage1.results[2].rider_uid, 'e5ffdd441b4e194d31b91dc6242d721b', 'uid is correct')
