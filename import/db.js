...
class Db {
  ...
  async insertRawResult (raceId, riderId, stageNumber, result) {
    const query = 'INSERT INTO raw_results(rank, time, status, class, stage_id, rider_id, race_id, acc_time_ms, stage_time_ms, stage_rank, final_status) VALUES($1, $2, $3, $4, (SELECT id from stages where race_id = $6 and number = $7), $5, $6, $8, $9, $10)'
