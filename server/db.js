...
class Db {
  ...
  async winnerTimeOfRace(raceId, gender, raceUid) {
    ...
    if (
      ...
      raceUid === "5760c4ce2fa8314cb992493dd99aa626" ||
      raceUid === "15f02667332f4a1c3eba7984e4dec34b"
    ) {
  ...
  async search(search, limit) {
    ...
    const query =
      "select id, name, club, uid from riders where search @@ to_tsquery('norwegian', $1) limit $2";
