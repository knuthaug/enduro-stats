...
*/
(function (a) { typeof module === 'object' && module.exports ? module.exports = a : typeof define === 'function' && define.amd ? define(function () { return a }) : a(typeof Highcharts !== 'undefined' ? Highcharts : void 0) })(function (a) {
  a.createElement('link', { href: 'https://fonts.googleapis.com/css?family\x3dUnica+One', rel: 'stylesheet', type: 'text/css' }, null, document.getElementsByTagName('head')[0]); a.theme = { colors: '#2b908f #90ee7e #f45b5b #7798BF #aaeeee #ff0066 #eeaaee #55BF3B #DF5353 #7798BF #aaeeee'.split(' '),
    ...
    rangeSelector: { buttonTheme: { fill: '#505053', stroke: '#000000', style: { color: '#CCC' }, states: { hover: { fill: '#707073', stroke: '#000000', style: { color: 'white' } }, select: { fill: '#000003', stroke: '#000000', style: { color: 'white' } } } }, inputBoxBorderColor: '#505053', inputStyle: { backgroundColor: '#333', color: 'silver' }, labelStyle: { color: 'silver' } },
